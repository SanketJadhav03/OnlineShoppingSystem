...
<head>
  <title>
    <?php
    echo isset($title) ? $title : "Online Shopping System";
    ?>
  </title>
  <?php
  $base_url = 'http://' . $_SERVER['HTTP_HOST'] . '/OnlineShoppingSystem/';
  if (!isset($_SESSION["customer_id"])) {
    $temp = $base_url . "login.php";
        ...
        <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
          <ul class="d-flex mt-3 justify-content-end list-unstyled m-0">
            ...
            if (isset($_SESSION['customer_name'])) {
              $username = $_SESSION['customer_name']; // Fetch the logged-in user's name
            } else {
            ...
            <li>
              <!-- If user is logged in, show the username, otherwise show a placeholder icon -->
